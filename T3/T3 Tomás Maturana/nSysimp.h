...
#define WAIT_PARTICULA STATUS_END+1   /* partícula espera para formar h2o  */
#define WAIT_TIMEOUT STATUS_END+2     /* oxígeno esperando hidrógenos con timeout */
